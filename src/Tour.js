...
<button className="text-red-600" onClick={() => setReadMore(!readMore)}>
{readMore ? 'Show less' :'Read more'}
</button>

               </p>
              <button class="font-bold flex mx-auto my-6 text-green-900   border-2 border-green-900 py-2 px-7 focus:outline-none hover:bg-green-900 hover:text-white rounded">
               Not interested
              </button>
            </div>
          </div>
